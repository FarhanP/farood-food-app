  ...
  return (
    <div>
      {items.map((item) => (
        ...
        >
          <div className="min-w-[150px] max-w-[150px] min-h-[150px] max-h-[150px] sm:max-w-[110px] sm:max-h-[110px]
          ...
          <div className="px-3">
            <h4 className="font-bold text-lg sm:text-base">{item?.card?.info?.name}</h4>
            ...
            <p className="text-sm pt-2 sm:pt-3">{item?.card?.info?.description}</p>
          </div>
        </div>
      ))}
    </div>
